                                    ...
                                    <li className="footer__col">
                                        ...
                                        <ul className="footer__socialmedia">
                                            <li className="footer__socialmedia__item">
                                                <a className="footer__socialmedia__iconlink" href="https://wa.me/5213322122459" target="_blank" rel="noreferrer">
                                                    <svg 
                                                    fill="currentColor" 
                                                    viewBox="0 0 448 512" 
                                                    height="30" 
                                            ...
                                            <li className="footer__socialmedia__item">
                                                <a className="footer__socialmedia__iconlink" href="https://www.facebook.com/profile.php?id=61550643887354" target="_blank" rel="noreferrer">
                                                    <svg 
                                                    fill="#fff" 
                                                    viewBox="0 0 448 512" 
                                                    height="30" 
                                            ...
                                            <li className="footer__socialmedia__item">
                                                <a className="footer__socialmedia__iconlink" href="https://www.instagram.com/sorteos.blackdiamond/" target="_blank" rel="noreferrer">
                                                    <svg 
                                            ...
                                            <li className="footer__socialmedia__item">
                                                <a className="footer__socialmedia__iconlink" href="https://www.tiktok.com/@sorteosblackdiamond" target="_blank" rel="noreferrer">
